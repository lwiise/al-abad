...
const RHYTHM: { n: number; name: string; bg: string; tone: string; dark?: boolean }[] = [
  ...
  { n: 8, name: "الآراء", bg: "bg-primary", tone: "plum + وهج lilac", dark: true },
  ...
  return (
    <>
      ...
      <Section bg="surface">
        <Group
          title="إيقاع الأقسام"
          note="ترتيب الصفحة الرئيسية. التناوب أبيض ↔ lilac، وثلاث مراسٍ داكنة: القسم ٣ على ink، والقسم ٧ على night، والقسم ٨ على plum. لا يُستخدم surface شريطاً متناوباً: الفرق بينه وبين الأبيض ١٫٠٧:١، أي دون عتبة الإدراك. القسم ٢ استثناء مقصود: يواصل لون surface نفسه — وهو اللون الذي تنتهي عليه الواجهة — فيقرآن ورقةً واحدة بلا خطّ فاصل. والقسم ٧ هو أغمق درجة في السلّم (neutral-900) لأن أرضيته حقل نقاطٍ حيّ: كل ما يكسبه اللوح من عمقٍ يُصرف في سطوع النقاط، وعلى ink كان الحقل سيُخفَّت حتى يزول. أما القسم ٨ فلا يجوز أن يكون داكناً محايداً بعده مباشرة — شريطان داكنان متجاوران بلا حدّ — فأخذ plum: خطوة في الصبغة لا في الإضاءة وحدها، ١٫٥٨:١ على neutral-900، وعند حافّته العليا حيث يلتقي الشريطان ٢٫٠٣:١ لأن الوهج هناك. ولم يبقَ من الأشرطة البيضاء المتتالية إلا ٩ و١٠، وفي كلٍّ منهما بطاقة لها حدّ وظلّ."
        >
