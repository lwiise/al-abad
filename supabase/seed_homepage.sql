...
update public.site_settings set
  ...
  testimonials_subhead    = 'كلماتٌ من أزواجٍ وزوجاتٍ ساروا في الطريق نفسه، وكتبوا ما تغيّر في بيوتهم بعد التطبيق.',
  testimonials_proof      = 'انضم إلى آلاف المتدربين والمتدربات الذين بدأوا من حيث أنت الآن.',
  testimonials_cta_label  = 'ابدأ رحلتك',
  testimonials_cta_url    = '/الدورات',
